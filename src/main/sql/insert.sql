...
-- Products
   -- Laxanika
      ...
      -- Piperies
         INSERT INTO product VALUES (NULL,"Piperis florinis xima","Πιπεριές Φλωρίνης Χύμα","Florinis","piperies","Masoutis",2.3);
         INSERT INTO product VALUES (NULL,"Piperis florinis xima","Πιπεριές Φλωρίνης Χύμα","Florinis","piperies","Sklavenitis",2.30);
         INSERT INTO product VALUES (NULL,"Piperis florinis xima","Πιπεριές Φλωρίνης Χύμα","Florinis","piperies","MyMarket",2.38);
         INSERT INTO product VALUES (NULL,"Piperis kauteres xima","Πιπεριές Καυτερές Χύμα","Kauteres","piperies","Masoutis",4.0);
         INSERT INTO product VALUES (NULL,"Piperis kauteres xima","Πιπεριές Καυτερές Χύμα","Kauteres","piperies","Sklavenitis",1.8);
         INSERT INTO product VALUES (NULL,"Piperis kauteres xima","Πιπεριές Καυτερές Χύμα","Kauteres","piperies","MyMarket",3.29);
      -- Manitaria
   ...
   -- Katepsigmena
      ...
      -- Laxanika 
         INSERT INTO product VALUES (NULL,"Arakas Barba Stathis 450g","Αρακάς Μπαρμπα Στάθης 450gr","Barba Stathis","laxanika","Masoutis",2.5);
			INSERT INTO product VALUES (NULL,"Arakas Barba Stathis 450g","Αρακάς Μπαρμπα Στάθης 450gr","Barba Stathis","laxanika","Sklavenitis",2.5);
			INSERT INTO product VALUES (NULL,"Arakas Barba Stathis 450g","Αρακάς Μπαρμπα Στάθης 450gr","Barba Stathis","laxanika","MyMarket",2.5);
         INSERT INTO product VALUES (NULL,"Fasolakia Barba Stathis 450g","Φασολάκια Μπαρμπα Στάθης 450gr","Barba Stathis","laxanika","Masoutis",2.6);
			INSERT INTO product VALUES (NULL,"Fasolakia Barba Stathis 450g","Φασολάκια Μπαρμπα Στάθης 450gr","Barba Stathis","laxanika","Sklavenitis",2.6);
			INSERT INTO product VALUES (NULL,"Fasolakia Barba Stathis 450g","Φασολάκια Μπαρμπα Στάθης 450gr","Barba Stathis","laxanika","MyMarket",2.5);
         INSERT INTO product VALUES (NULL,"Arakas Mr.Grand 450g","Αρακάς Mr.Grand 450gr","Mr.Grand","laxanika","Masoutis",2.0);
			INSERT INTO product VALUES (NULL,"Arakas Marata 450g","Αρακάς Μαράτα 450gr","Marata","laxanika","Sklavenitis",2.1);
         INSERT INTO product VALUES (NULL,"Fasolakia Mr.Grand 450g","Φασολάκια Mr.Grand 450gr","Mr.Grand","laxanika","Masoutis",2.1);
			INSERT INTO product VALUES (NULL,"Fasolakia Marata 450g","Φασολάκια Μαράτα 450gr","Marata","laxanika","Sklavenitis",2.2);
      -- Pites
